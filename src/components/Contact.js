                    ...
                    <div className="row">
                        <div className="col-lg-10 offset-lg-1 d-flex justify-content-between">
                            ...
                            <div className="contact-info-item mt-3 d-flex justify-content-start align-items-center">
                                ...
                                <div className="contact_info_content d-flex">
                                    <div className="contact-info-title ps-2">
                                        Phone
                                    </div>
                        ...
                        <div className="contact_form-container py-5">
                         ...
                         <form method='POST' id="contact_form">
                             <div className="contact_form_name d-flex justify-content-between align-items-between">
                                      <input type="text" id="contact_form_name" className="contact_form_name input_field" placeholder="Your Name" required="true"  name="name" value={userData.name}  onChange={handleInputs}  />

                                      <input type="email" id="contact_form_email" className="contact_form_email input_field" placeholder="Your Email" required="true" name="email" value={userData.email} onChange={handleInputs}/>
